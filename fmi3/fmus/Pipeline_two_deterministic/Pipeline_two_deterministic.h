...
#ifndef Pipeline_two_deterministic_h
#define Pipeline_two_deterministic_h
...
class Pipeline_two_deterministic : public InstanceBase {
...
#endif // Pipeline_two_deterministic_h
