...
#ifndef Pipeline_three_deterministic_h
#define Pipeline_three_deterministic_h
...
class Pipeline_three_deterministic : public InstanceBase {
...
#endif // Pipeline_three_deterministic_h
