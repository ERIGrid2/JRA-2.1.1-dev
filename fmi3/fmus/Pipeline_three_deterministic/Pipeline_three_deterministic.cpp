...
#include "Pipeline_three_deterministic.h"
#include <ostream>
#include <iostream>
#include <limits>
#include <algorithm>
...
Pipeline_three_deterministic::Pipeline_three_deterministic(
...
{
    std::cout << ">> Pipeline_three_deterministic::constructor" << std::endl << std::flush;
    ...
    this->logDebug(
        "successfully initialized class %s", "Pipeline_three_deterministic"
    );
    std::cout << "<< Pipeline_three_deterministic::constructor" << std::endl << std::flush;
}

fmi3Status Pipeline_three_deterministic::enterInitializationMode(
    ...
    std::cout << ">> Pipeline_three_deterministic::enterInitializationMode" << std::endl << std::flush;
...
fmi3Status
Pipeline_three_deterministic::exitInitializationMode()
{
    std::cout << ">> Pipeline_three_deterministic::exitInitializationMode" << std::endl << std::flush;
 ...
 */
fmi3Status 
Pipeline_three_deterministic::enterEventMode(
    ...
    std::cout << ">> Pipeline_three_deterministic::enterEventMode" << std::endl << std::flush;
    ...
    std::cout << "  eventHappenedInternal1=" << this->eventHappenedInternal1 << ", eventHappenedInternal2=" << this->eventHappenedInternal2 << ", eventHappenedInternal3=" << this->eventHappenedInternal3 << std::endl << std::flush;
...
fmi3Status
Pipeline_three_deterministic::reset()
{
    std::cout << ">> Pipeline_three_deterministic::reset" << std::endl << std::flush;
    pipe1.reset();
    pipe2.reset();
    pipe3.reset();
...
fmi3Status
Pipeline_three_deterministic::getInt32(
    const fmi3ValueReference valueReferences[],
    size_t nValueReferences,
    fmi3Int32 values[],
    size_t nValues
) {
    std::cout << ">> Pipeline_three_deterministic::getInt32" << std::endl << std::flush;
...
fmi3Status
Pipeline_three_deterministic::getClock(
    const fmi3ValueReference valueReferences[],
    size_t nValueReferences,
    fmi3Clock values[]
) {
    std::cout << ">> Pipeline_three_deterministic::getClock" << std::endl << std::flush;
    /*if ( nValueReferences != nValues ) {
        this->logError(
            "%s %s",
            "This FMU only supports scalar variables.",
...
fmi3Status
Pipeline_three_deterministic::setInt32(
    const fmi3ValueReference valueReferences[],
    size_t nValueReferences,
    const fmi3Int32 values[],
    size_t nValues
) {
    std::cout << ">> Pipeline_three_deterministic::setInt32" << std::endl << std::flush;
    if ( nValueReferences != nValues ) {
        this->logError(
            "%s %s",
            "This FMU only supports scalar variables.",
...
fmi3Status
Pipeline_three_deterministic::setFloat64(
    const fmi3ValueReference valueReferences[],
    size_t nValueReferences,
    const fmi3Float64 values[],
    size_t nValues
) {
    std::cout << ">> Pipeline_three_deterministic::setFloat64" << std::endl << std::flush;
    if ( nValueReferences != nValues ) {
        this->logError(
            "%s %s",
            "This FMU only supports scalar variables.",
...
fmi3Status
Pipeline_three_deterministic::setClock(
    const fmi3ValueReference valueReferences[],
    size_t nValueReferences,
    const fmi3Clock values[])
{
    std::cout << ">> Pipeline_three_deterministic::setClock" << std::endl << std::flush;
/*    if ( nValueReferences != nValues ) {
        this->logError(
            "%s %s",
            "This FMU only supports scalar variables.",
...
fmi3Status
Pipeline_three_deterministic::updateDiscreteStates(
    ...
    std::cout << ">> Pipeline_three_deterministic::updateDiscreteStates" << std::endl << std::flush;
    ...
    if (ic12.hasMessage()) {
        ...
        std::cout << "### Message from pipe1/2: " << msg << ", inserting into pipe3" << std::endl << std::flush;
    ...
    *nextEventTimeDefined = fmi3False;
    ...
    std::cout << "%%%%%%% Next Event times: pipe 1=" << net1 << ", pipe2=" << net2 << ", pipe3=" << net3 << ", combined=" << netime << std::endl << std::flush;
...
fmi3Status
Pipeline_three_deterministic::doStep(
    ...
    std::cout << ">> Pipeline_three_deterministic::doStep" << std::endl << std::flush;
...
void
Pipeline_three_deterministic::deactivateAllClocks()
{
    std::cout << ">> Pipeline_three_deterministic::deactivateAllClocks" << std::endl << std::flush;
